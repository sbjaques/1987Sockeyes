  ...
  return (
    <section className="bg-navy text-cream">
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        ...
        <p className="text-cream/70 text-sm uppercase tracking-widest mb-4">
          Four trophies in ten weeks.
        </p>
        <p className="text-cream/80 text-base max-w-3xl mb-8 leading-relaxed">
          In Canadian Junior A hockey, a team wins the national championship by climbing four
          playoff ladders in a row: the BC league final, the BC provincial championship, the
          Western Canadian final, and the Centennial Cup — the national title. The Sockeyes
          swept all four.
        </p>

        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6 mb-10">
          <Stat headline="38-14-0" caption="BC Junior A regular season" detail="Coast Division champions, +104 goal differential" />
          <Stat headline="15-0" caption="BC Junior A playoffs" detail="Swept Nanaimo, North Delta & Kelowna (45-5-2)" />
        ...
        <div className="prose prose-invert max-w-none text-cream/90 space-y-4">
          <p>
            ...
            with a +104 goal differential and three scorers in the top ten of the BC Junior A league (the
            BCJHL). Dave Tomlinson (43-65-108, 2nd in the league), Rob Clarke (65-38-103, 3rd), and Bryon
            Moller (27-64-91, 6th) anchored an offence built on line chemistry: Phillips–Kozak–Hardy, and
            Tomlinson at centre.
          </p>
          <p>
          ...
          <p>
            The Abbott Cup went seven games against the Humboldt Broncos, who had gone 55-9 in the
            Saskatchewan Junior league and ridden a 17-game winning streak of their own into the Western
            Final. Richmond broke the streak and took the series 4-3. At the Centennial Cup in Humboldt,
            the Sockeyes beat Dartmouth 7-3, Pembroke 4-3, and — after dropping a round-robin game to the
            hosts 6-1 — routed Pembroke 9-3 in the semifinal and beat Humboldt 5-2 in the final on May 9,
            1987 at the Uniplex. Frank Romeo was named tournament MVP. Jason Phillips was named Most
            Gentlemanly Player and to the tournament All-Star team, recording a hat trick in the final.
          </p>
          <p className="mt-8">
            <Link
              to="/the-season"
